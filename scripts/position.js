document.addEventListener(`DOMContentLoaded`, () => {
    ...
    function UpdateInventory() {
        ...
        for (item of inventoryArray) {
            if (item.empty == true) {
                ...
                ids.push(item);
                if (item.use == "Healing" || item.use == "Eat" || item.use == "SuperEat") {
    ...
    let itemOnRoomBedroom = [
        ...
        new ItemInRoom(4, 5, "Super Soup", "You find a can of soup under the bed.", "Give infinite stamina when eaten.", "sprites/SuperSoup.png", "SuperEat"), //change to better
        ...
        for (item of room) {
            if (characterPosition.x == item.ox && characterPosition.y == item.oy && item.name == `Oven` && item.work == true) {
                ...
                if (repForUseOven2 == true) {
                    ...
                    document.getElementById("interract").addEventListener(`click`, () => {
                        if (characterPosition.x == itemCopy.ox && characterPosition.y == itemCopy.oy && roomIn == "Kitchen") {
                            document.getElementById("textContent").classList.toggle("displayNone");
                            document.getElementById("textContent").innerHTML = `                  
                            <div id="textLeft">
                              <img src="sprites/Narrator.png" alt="">
        ...
        for (item of room) {
            if (characterPosition.x == item.ox && characterPosition.y == item.oy && item.name == `Oven` && item.work == false) {
                ...
                if (repForOven == true) {
                    ...
                    document.getElementById("interract").addEventListener(`click`, () => {
                        if (characterPosition.x == itemCopy.ox && characterPosition.y == itemCopy.oy && itemCopy.work == false) {
                            document.getElementById("textContent").classList.toggle("displayNone");
                            document.getElementById("textContent").innerHTML = `                  
                            <div id="textLeft">
                              <img src="sprites/Narrator.png" alt="">
        ...
        for (item of room) {
            if (characterPosition.x == item.x && characterPosition.y == item.y && item.name == "Cat" && item.thereC == true) {
                ...
                if (repForCat == true) {
                    ...
                    document.getElementById("interract").addEventListener(`click`, () => {
                        if (characterPosition.x == itemCopy.x && characterPosition.y == itemCopy.y && CATTTTT == true && roomIn != "Rocketo" && roomIn != "Stairs" && roomIn != "Dinning" && roomIn != "Bedroom") {
                            document.getElementById("textContent").classList.toggle("displayNone");
                            document.getElementById("textContent").innerHTML = `                  
                            <div id="textLeft">
                              <img src="sprites/Narrator.png" alt="">
        ...
        for (item of room) {
            if (characterPosition.x == item.rx && characterPosition.y == item.ry) {
                ...
                if (repSearchItemsRedKey == true) {
                    ...
                    document.getElementById("interract").addEventListener(`click`, () => {
                        if (itemCopy.there == true && characterPosition.x == itemCopy.rx && characterPosition.y == itemCopy.ry) {
                            if (Object.keys(itemCopy).includes("haveKey") && itemCopy.haveKey == false) {
                                document.getElementById("textContent").innerHTML = `                  
                            <div id="textLeft">
                              <img src="${itemCopy.img}" alt="">
    ...
    function searchItems() {
        ...
        for (item of room) {
            if (characterPosition.x == item.x && characterPosition.y == item.y) {
                ...
                document.getElementById("interract").addEventListener(`click`, () => {
                    if (itemCopy.there == true && characterPosition.x == itemCopy.x && characterPosition.y == itemCopy.y) {
                        for (item of room) {
                            if (itemCopy.x == item.x && itemCopy.y == item.y && item.img == itemCopy.img) {
        ...
        switch (key.key) {
            ...
            case "o":
                if (adminMode == true) {
                    ...
                    stamina = stamina + 1;
                    updateStamina();
                    console.log("Health and stamina added");    
                    break
                }
            case "h":
                if (adminMode == true) {
                    if(adminImmortality == true){
                        adminImmortality = false;
                        console.log("Admin Immortality off");    
                    }
                    else{
                        adminImmortality = true;
                        console.log("Admin Immortality on");    
                    }
                    break
                }
            case "g":
                if (adminMode == true) {
                    stamina = stamina + 999;
                    console.log("999 stamina added");    
                    updateStamina();
                    break
                }
            case "b":
                if (adminMode == true) {
                    console.log("Rocketo fight ");    
                    rocketoFight();
                    break
                }
            case "c":
                if (adminMode == true) {
                    console.log("Credits for Diego & Matthew");    
                    break
                }
            case "i": 
                if (adminMode == true) {
                console.log("'o': Add 1 health and 1 stamina");   
                console.log("'h': Admin Immortality mode on/off");    
                console.log("'g': +999 stamina");    
                console.log("'b': Start Rocketo Fight");    
    ...
    function addToHistory(line){
        historyArray.push({who: line.who, text: line.text});
    }
    let htmlForHistory = "";
    function updateHistory(){
        htmlForHistory = "";
        for (line of historyArray) {
            htmlForHistory = htmlForHistory + `<p>${line.who}: ${line.text}</p>`
        }
        document.getElementById("history").innerHTML = htmlForHistory;
    ...
    let storyHorse = [];
    let storyCar = [];
    let storyFortuneteller = [];
    let storyEnd = [];
    let carEnding = [];
    let horseEnding = [];
    let fortunetellerEnding = [];
    ...
    function updateText(number, story) {
        switch (true) {
            ...
            case Object.keys(story[number]).includes("who"):
                ...
                else if (story[number].who == "Horse Grandma") {
                    document.getElementById("textContent").innerHTML = `                  
                    <div id="textLeft">
                      <img src="sprites/HorseGrandma.png" alt="">
                    </div>
                    <div id="textRight">
                      <h2>${story[number].who}</h2>
                      <p>${story[number].text}</p>
                ...
                else if (story[number].who == "No ghost Grandma") {
                    document.getElementById("textContent").innerHTML = `                  
                    <div id="textLeft">
                      <img src="sprites/GrandmaAlive.png" alt="">
                    </div>
                    <div id="textRight">
                      <h2>${story[number].who}</h2>
                      <p>${story[number].text}</p>
                ...
                else if (story[number].who == "Tutorial boy") {
                    document.getElementById("textContent").innerHTML = `                  
                    <div id="textLeft">
                      <img src="sprites/Cina.png" alt="">
                    </div>
                    <div id="textRight">
                      <h2>${story[number].who}</h2>
                      <p>${story[number].text}</p>
    ...
    function optionLoader2(code1, code2) {
        document.getElementById("textLeftO").addEventListener(`click`, () => {
            ...
            if (code1 == "addAxe") {
                axe = true;
                rocketoLife = 2;
                addInventory("sprites/Axe.png", "A strong axe, doubles your damage.");// no use
                UpdateInventory();
            }
    ...
    function storageRoom() {
        ...
        addMap("sprites/CarBack.png", 8, 3);
        addMap("sprites/CarFront.png", 7, 3);
        addMap("sprites/CarBack2.png", 8, 2);
        addMap("sprites/CarFront2.png", 7, 2);
        ...
        addMap("sprites/box.png", 1, 5);
        addMap("sprites/box.png", 2, 5);
        addMap("sprites/box.png", 3, 5);
        addMap("sprites/box.png", 4, 5);
        addMap("sprites/box.png", 4, 6);
        addMap("sprites/box.png", 4, 7);
        addMap("sprites/box.png", 4, 8);
    ...
    // admin mode activation HAHAHA

    let adminMode = false;
    let keyq = false;
    let adminImmortality = false;
    document.addEventListener("keydown", (key) => {
        if (key.key == "q") {
            keyq = true;
            setTimeout(() => {
